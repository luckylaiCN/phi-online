...
// 加载图像和声音资源
Loader.add([
        { name: 'tap', url: '/static/img/Tap.png' },
        { name: 'tap2', url: '/static/img/Tap2.png' },
        { name: 'tapHl', url: '/static/img/TapHL.png' },
        { name: 'drag', url: '/static/img/Drag.png' },
        { name: 'dragHl', url: '/static/img/DragHL.png' },
        { name: 'flick', url: '/static/img/Flick.png' },
        { name: 'flickHl', url: '/static/img/FlickHL.png' },
        { name: 'holdHead', url: '/static/img/HoldHead.png' },
        { name: 'holdHeadHl', url: '/static/img/HoldHeadHL.png' },
        { name: 'holdBody', url: '/static/img/Hold.png' },
        { name: 'holdBodyHl', url: '/static/img/HoldHL.png' },
        ...
        { name: 'judgeIconFalse', url: '/static/img/judgeIcons/false.png' },
        { name: 'judgeIconC', url: '/static/img/judgeIcons/c.png' },
        { name: 'judgeIconB', url: '/static/img/judgeIcons/b.png' },
        { name: 'judgeIconA', url: '/static/img/judgeIcons/a.png' },
        { name: 'judgeIconS', url: '/static/img/judgeIcons/s.png' },
        { name: 'judgeIconV', url: '/static/img/judgeIcons/v.png' },
        { name: 'judgeIconPhi', url: '/static/img/judgeIcons/phi.png' },

        { name: 'soundTap', url: '/static/sound/Hitsound-Tap.ogg' },
        { name: 'soundDrag', url: '/static/sound/Hitsound-Drag.ogg' },
        { name: 'soundFlick', url: '/static/sound/Hitsound-Flick.ogg' },

        { name: 'levelOverEZ', url: '/static/sound/levelOver/ez.ogg' },
        { name: 'levelOverHD', url: '/static/sound/levelOver/hd.ogg' },
        { name: 'levelOverIN', url: '/static/sound/levelOver/in.ogg' },
        { name: 'levelOverAT', url: '/static/sound/levelOver/at.ogg' },
        { name: 'levelOverSP', url: '/static/sound/levelOver/sp.ogg' }
    ])
    .load(function(event) {
